...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
	...
	<script type="text/javascript">
		$(function () {
			...
			var defaultText = "Seperate multiple values by a comma. Eg. Chair, Kettle";
		...
		function BITSemail() {
			var inputText = $("#BodyContentPlaceHolder_Username_TextBox").val();
			if (inputText.search(/^[a-z]+@bits\-goa.ac.in$/) >= 0) {
				return true;
			}
			else {
				return false;
				...
				<table cellpadding="3px" cellspacing="15px">
					<tr>
						<td class="style3" colspan="3">
							<center>
								Go to student&#39;s sign up <a href="../Sign_Up/Default.aspx">here</a></center>
						</td>
					</tr>
					<tr>
						<td class="style4">
						...
						<td class="style1">
							...
							<asp:TextBox ID="Student_Name_TextBox" runat="server" CssClass="validate[required,custom[onlyLetter],length[3,30]]"
								MaxLength="30" EnableViewState="False" Width="260px"></asp:TextBox>
						</td>
						<td class="style2">
							&nbsp;
						</td>
					...
					<tr>
						<td class="style4">
							<asp:Label ID="BITS_ID_Label" runat="server">PSR No.</asp:Label>
							&nbsp;*
						</td>
						<td class="style1">
							:
							<asp:TextBox ID="BITS_ID_TextBox" runat="server" CssClass="validate[required,custom[onlyNumber]]"
								EnableViewState="False" AutoComplete="Off" Width="77px"></asp:TextBox>
						</td>
						<td class="style2">
					...
					<tr>
						<td class="style4" >
							<asp:Label ID="Username_Label" runat="server"   Text="BITS e-mail"></asp:Label>
							&nbsp;*
						</td>
						<td class="style1">
							:
							<asp:TextBox ID="Username_TextBox" runat="server" 
								MaxLength="100" EnableViewState="False" AutoComplete="Off" 
                                CssClass="validate[required,custom[BITSemail]]" Width="260px"></asp:TextBox>
						    <br />
&nbsp;Ex. xyz@goa.bits-pilani.ac.in</td>
						<td class="style2">
							<p id="usernameResult">
							</p>
						</td>
					...
					<tr>
						...
						<td class="style1">
							...
							<asp:TextBox ID="Password_TextBox" TextMode="Password" runat="server" EnableViewState="False"
								CssClass="validate[required,length[5,20]]" MaxLength="20" Width="260px"></asp:TextBox>
						</td>
						<td class="style2">
							&nbsp;
						</td>
					...
					<tr>
						...
						<td class="style1">
							...
							<asp:TextBox ID="RettypePass_TextBox" runat="server" EnableViewState="False" TextMode="Password"
								...
								MaxLength="20" Width="260px"></asp:TextBox>
						</td>
						<td class="style2">
							&nbsp;
						</td>
					...
					<%--<tr>
						<td class="style3">
							<asp:Label ID="Hostel_Label" runat="server" Text="Chamber No."></asp:Label>
							&nbsp;*
						</td>
						<td class="style1">
							:
							<asp:TextBox ID="Chamber_TextBox" runat="server" CssClass="validate[required]"></asp:TextBox>
						</td>
						<td class="style2">
							&nbsp;
						</td>
					...
					<tr>
						<td class="style3">
							<asp:Label ID="Room_No_Label" runat="server" Text="Quarter No."></asp:Label>
							&nbsp;*
						</td>
						<td class="style1">
							:
							<asp:TextBox ID="Quarter_No_TextBox" runat="server" CssClass="validate[required]"
								MaxLength="3" EnableViewState="False"></asp:TextBox>
						</td>
						<td class="style2">
							&nbsp;
						</td>
					...
					<tr>
						...
						<td class="style1">
							...
							<asp:TextBox ID="Phone_no_TextBox" runat="server" CssClass="validate[required, custom[telephone]]"
								MaxLength="10" EnableViewState="False" Width="260px"></asp:TextBox>
						</td>
						<td class="style2">
							&nbsp;
						</td>
				...
				<div id="mailAlertSubscribe" style="margin-top: 10px; padding: 0 30px;">
					<table border="0" cellspacing="0" cellpadding="5">
						<tr valign="middle">
							...
							<td>
								&nbsp;<label for="BodyContentPlaceHolder_subscribe">Subscribe to notifications!</label>
							</td>
						</tr>
					</table>
					<br />
					...
					<fieldset style="padding: 10px 20px; display: inline-block;" id="subsciptionForm">
						<legend>&nbsp;Get Notified when...&nbsp;</legend>
						<table border="0" cellpadding="0" cellspacing="8" title="Seperate multiple values by a comma. Eg. Chair, Kettle">
							<tr>
								<td>
								...
								<td>
									<input type="text" name="itemsCloud" id="itemsCloud" value="Seperate multiple values by a comma. Eg. Chair, Kettle"
										class="default SText" title="Seperate multiple values by a comma. Eg. Chair, Kettle"
										runat="server" placeholder="Seperate multiple values by a comma. Eg. Chair, Kettle" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="text" name="studentsCloud" id="studentsCloud" value="Seperate multiple values by a comma. Eg. Chair, Kettle"
										class="default SText" title="Seperate multiple values by a comma. Eg. Chair, Kettle"
										runat="server" placeholder="Seperate multiple values by a comma. Eg. Chair, Kettle" />
								</td>
							</tr>
