...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
	...
	<script type="text/javascript">
		function BITSID_Validate() {
			if (document.getElementById("BodyContentPlaceHolder_BITS_ID_TextBox").value.length < 12)
				return false;
			return true;
		}
	</script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="Server">
	...
	<div style="display: none;">
		<table id="EmailTable" width='100%' border='0' cellspacing='5' cellpadding='0' style='font-family: Segoe UI, Verdana, Arial, sans-serif;' runat="server">
			<tr>
				<td colspan='4' align='center'>
					<h2>
						<a style='font-weight: lighter; color: #900; text-decoration: underline;' runat="server" id="eBayLink">Campus
							eBay : Forgot Password</a></h2>
				</td>
			</tr>
			<tr>
				<td colspan='4'>
